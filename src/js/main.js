...
const Examples = (props) => {
	return (
		<div style={{ fontFamily: 'Arial' }}>
        	...
        	<h3>If you want to know how these examples were done, <a href="https://github.com/enzoferey/react-rating-system/blob/master/src/js/main.js">click here to get the source code</a> !</h3>
